...
export default function ResultModal({result,bottomSheetModalRef,handleSheetChanges}:{result:any,bottomSheetModalRef:any,handleSheetChanges:any}){
    return(
        <BottomSheetModal
          ...
          >
            <BottomSheetView style={styles.modalView}>
              ...
              <View style={styles.headerCard}>
                <Image source={require("@/assets/images/paix-dieu.png")} style={styles.image} resizeMode="contain" />
              <View style={styles.circle}></View>
              </View>
                  <Text style={styles.modalText}>
                    {result?.data?.nom || "Aucun résultat"}
                  </Text>
